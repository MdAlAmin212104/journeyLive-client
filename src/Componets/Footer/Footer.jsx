...
const Footer = () => {
      return (
            <div className='my-8 roboto'>
                  {/* Newsletter */}
                  <div className="bg-gradient-to-r from-[#F9F3F0] from-10% via-[#FCE7DC] via-30% to-[#F9F3F0] to-90% dark:bg-gradient-to-r dark:from-[#f2f2d8] dark:from-10% dark:via-[#FCE7DC] dark:via-30% dark:to-[#fae1d4] gadgetContainer pl-4 my-8 rounded-xl">
                  ...
                  <div>
                        ...
                        <div className="mx-auto w-full  p-4 py-6 lg:py-8">
                              ...
                              <Link  to='/' className="flex items-center">
                                    <h2 className='text-5xl text-[tomato] poppins'>
                                          JourneyLive
                                    </h2>
